...
<body>
    <div class="py-4 mb-6 shadow-sm">
        <div class="container flex justify-between">
            <h1>
                <a class="italic flex justify-center items-center text-lime-500 text-3xl" href="/"><span
                          class="mr-1">Spring</span>
                    <svg id="Layer_1" height="35px" width="35px" version="1.1" xmlns="http://www.w3.org/2000/svg"
            ...
            <form class="flex items-center" action="{{ route('inventory.index') }}">
                ...
                <div class="relative w-[400px]">
                    ...
                    <input class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-lime-500 focus:border-lime-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-lime-500 dark:focus:border-lime-500"
                           id="simple-search" name="search" type="text" value="{{ request('search') }}"
                           placeholder="Search">
                </div>
